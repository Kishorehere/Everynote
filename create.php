...
<body>
		...
		<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		    ...
		    <a href="#" class="navbar-brand" style ="padding-left: 2%;"><small>Hello <?php echo $userName; ?> !</small></a>
	...
	<div class = "container" style ="padding-top: 5%;padding-right: 0px;padding-left: 0px;padding-bottom: 5%;border: solid;border-color: yellow;border-radius: 10px; margin: auto;margin-top: 5%;margin-bottom: 5%; align-self: center;">
      ...
      <form method = "POST" style = "width: 60%; margin:auto;" action ="create.php">
      	
	      	<div class = "form-group" style = "text-align: center;margin-bottom:10%;">
	      		<h2><strong>Create Note</strong></h2>
	      	</div>
        
            <div class = "form-group">
              <label>Title</label>
              <input type="text" name = "title" class ="<?php echo $titleClass;?>" placeholder="Title" value="<?php echo isset($_POST['title']) ? $title : "";?>">
            ...
            <div class="form-group">
			    <label>Content</label>
			    <textarea class="<?php echo $contentClass;?>" name="content" rows="3"  placeholder="Note to be stored"  value="<?php echo isset($_POST['content']) ? $content : "";?>"></textarea>
			    <div class = "invalid-feedback"><?php echo $titleComment; ?></div>
              	<div class = "valid-feedback">Looks Good!</div>
			</div>
			...
			<div class = "form-group">
              <label>Image</label>
              <input type="text" name = "image" class ="form-control" placeholder="image name with extension" value="<?php echo isset($_POST['image']) ? $imageLink : "";?>">
	        ...
	        <div class="row">
	        	<div class = "col">
	        		<div style = "margin-left: 34%;margin-top: 30px;">
	        			<button type = "submit" class = "btn btn-outline-warning" style="width:200px;" name ="create" >Add Note</button>
	        		</div>
	        	</div>
	        </div>
